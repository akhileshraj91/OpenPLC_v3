...
typedef struct {
  ...
  __DECLARE_LOCATED(BOOL,FIRST_RUN)
  ...
  __DECLARE_VAR(UINT,_TMP_MOVE13_OUT)
  __DECLARE_VAR(BOOL,_TMP_MOVE20_ENO)
  __DECLARE_VAR(UINT,_TMP_MOVE20_OUT)
  __DECLARE_VAR(BOOL,_TMP_MOVE19_ENO)
  __DECLARE_VAR(UINT,_TMP_MOVE19_OUT)
  __DECLARE_VAR(BOOL,_TMP_MOVE25_ENO)
  __DECLARE_VAR(UINT,_TMP_MOVE25_OUT)
